...
ActiveRecord::Schema.define(version: 20131030135024) do
  ...
  add_index "matches", ["manager_id", "manager_type"], name: "index_matches_on_manager_id_and_manager_type", using: :btree
  ...
  add_index "players", ["contest_id"], name: "index_players_on_contest_id", using: :btree
  ...
  add_index "referees", ["user_id"], name: "index_referees_on_user_id", using: :btree
